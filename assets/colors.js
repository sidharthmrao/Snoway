...
export const Color = {
    WHITE: '#FFFFFF',
    BLACK: '#000000',
    BG1: isDarkMode ? '#B4D2E7' : '#B4D2E7',
    TEXTONBG1: isDarkMode ? '#79A3F0' : '#79A3F0',
    BG2: isDarkMode ? '#407EEA' : '#407EEA',
    TEXTONBG2: isDarkMode ? '#B4D2E7' : '#B4D2E7',
    BG3: isDarkMode ? '#F8F8F8' : '#F8F8F8',
    TEXTONBG3: isDarkMode ? '#2C3847' : '#2C3847',
    GREYONBG3: isDarkMode ? '#C6CAD0' : '#C6CAD0',
